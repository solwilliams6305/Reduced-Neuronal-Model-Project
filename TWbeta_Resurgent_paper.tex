...
$S_0=1/\pi$; \S\ref{ssec:adep}) and hence bounded for $a\ge a_0$. The two directions share the single
...
\emph{Refinements:} the $\alpha=\tfrac12/\alpha=0$ family assignment (Rem.~\ref{rem:family}); the
explicit large-order value of $S(a)$'s subleading $a$-corrections (needs the all-order $R_m$), and
rough-potential rigidity rigor (Rem.~\ref{rem:elem}). \emph{Open frontier:} Conjecture~\ref{conj:frontier}.
